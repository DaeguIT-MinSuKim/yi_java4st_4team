package yi_java4st_4team.start;
...
import yi_java4st_4team.TableTotal.TableTotalFrame;
import yi_java4st_4team.payTotal.document.PayTotalFrame;
...
public class Main extends JPanel implements ActionListener {
	...
	private TableTotalFrame seatTotal;
	private PayTotalFrame salesCondition;
	...
	protected void actionPerformedBtnCellControl(ActionEvent e) {
		if (salesCondition == null) {
			salesCondition = new PayTotalFrame();
		}
